...
namespace TradeUnionCommittee.BLL.Services.Directory
{
    public class HobbyService : IHobbyService
    {
        ...
        public HobbyService(IUnitOfWork database, IAutoMapperUtilities mapperService, ICheckerService checkerService)
        {
            _database = database;
        ...
        {
            var check = await _checkerService.CheckDecryptWithId(hashId, Enums.Services.Hobby);
        ...
        {
            var check = await _checkerService.CheckDecryptWithId(dto.HashId, Enums.Services.Hobby);
            if (check.IsValid)
            {
                if (!await CheckNameAsync(dto.Name))
                {
