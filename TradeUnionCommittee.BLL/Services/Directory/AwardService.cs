...
namespace TradeUnionCommittee.BLL.Services.Directory
{
    public class AwardService : IAwardService
    {
        ...
        {
            var check = await _hashIdUtilities.CheckDecryptWithId(hashId, Enums.Services.Award);
        ...
        {
            var check = await _hashIdUtilities.CheckDecryptWithId(dto.HashId, Enums.Services.Award);
            if (check.IsValid)
            {
                if (!await CheckNameAsync(dto.Name))
                {
