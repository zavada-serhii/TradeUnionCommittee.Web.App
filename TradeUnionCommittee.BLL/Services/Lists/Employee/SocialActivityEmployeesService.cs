...
namespace TradeUnionCommittee.BLL.Services.Lists.Employee
{
    public class SocialActivityEmployeesService : ISocialActivityEmployeesService
    {
        ...
        public SocialActivityEmployeesService(TradeUnionCommitteeContext context, IAutoMapperConfiguration mapperService, IHashIdConfiguration hashIdUtilities)
        {
            _context = context;
        ...
        public async Task<ActualResult> DeleteAsync(string hashId)
        {
            try
            {
                var id = _hashIdUtilities.DecryptLong(hashId, Enums.Services.SocialActivityEmployees);
