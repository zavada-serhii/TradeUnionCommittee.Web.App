...
namespace TradeUnionCommittee.BLL.Services.Lists.Employee
{
    public class AwardEmployeesService : IAwardEmployeesService
    {
        ...
        public AwardEmployeesService(TradeUnionCommitteeContext context, IAutoMapperConfiguration mapperService, IHashIdConfiguration hashIdUtilities)
        {
            _context = context;
        ...
        public async Task<ActualResult<IEnumerable<AwardEmployeesDTO>>> GetAllAsync(string hashIdEmployee)
        {
            ...
            {
                return new ActualResult<IEnumerable<AwardEmployeesDTO>>(Errors.DataBaseError);
            }
        }
        ...
        public async Task<ActualResult<AwardEmployeesDTO>> GetAsync(string hashId)
        {
            ...
            {
                return new ActualResult<AwardEmployeesDTO>(Errors.DataBaseError);
            }
        }
