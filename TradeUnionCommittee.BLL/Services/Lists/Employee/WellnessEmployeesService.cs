...
namespace TradeUnionCommittee.BLL.Services.Lists.Employee
{
    public class WellnessEmployeesService : IWellnessEmployeesService
    {
        ...
        public WellnessEmployeesService(TradeUnionCommitteeContext context, IAutoMapperConfiguration mapperService, IHashIdConfiguration hashIdUtilities)
        {
            _context = context;
        ...
        public async Task<ActualResult<IEnumerable<WellnessEmployeesDTO>>> GetAllAsync(string hashIdEmployee)
        {
            ...
            {
                return new ActualResult<IEnumerable<WellnessEmployeesDTO>>(Errors.DataBaseError);
            }
        }
        ...
        public async Task<ActualResult<WellnessEmployeesDTO>> GetAsync(string hashId)
        {
            ...
            {
                return new ActualResult<WellnessEmployeesDTO>(Errors.DataBaseError);
            }
        }
