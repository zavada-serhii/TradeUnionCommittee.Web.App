...
namespace TradeUnionCommittee.BLL.Services.Account
{
    public class AccountService : IAccountService
    {
        ...
        public AccountService(IUnitOfWork database, IAutoMapperService mapperService)
        {
            _database = database;
        ...
        public Task<ActualResult<IEnumerable<AccountDTO>>> GetAllUsersAsync()
        {
            throw new System.NotImplementedException();
        }

        public Task<ActualResult<AccountDTO>> GetUserAsync(string hashId)
        {
            throw new System.NotImplementedException();
        }

        public Task<ActualResult> CreateUserAsync(AccountDTO dto)
        {
            throw new System.NotImplementedException();
        }

        public Task<ActualResult> UpdateUserEmailAsync(AccountDTO dto)
        {
            throw new System.NotImplementedException();
        }

        public Task<ActualResult> UpdateUserPasswordAsync(AccountDTO dto)
        {
            throw new System.NotImplementedException();
        }

        public Task<ActualResult> UpdateUserRoleAsync(AccountDTO dto)
        {
            throw new System.NotImplementedException();
        }

        public Task<ActualResult> DeleteUserAsync(string hashId)
        {
            throw new System.NotImplementedException();
        }
        ...
        public Task<ActualResult<IEnumerable<RolesDTO>>> GetRoles()
        {
            throw new System.NotImplementedException();
        }

        public Task<ActualResult<RolesDTO>> GetRoleId(string hashId)
        {
            throw new System.NotImplementedException();
        }
