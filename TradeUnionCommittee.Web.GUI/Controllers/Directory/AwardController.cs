...
namespace TradeUnionCommittee.Web.GUI.Controllers.Directory
{
    public class AwardController : Controller
    {
        ...
        public AwardController(IAwardService services, IOops oops)
        {
            _services = services;
            _oops = oops;
        }
        ...
        public async Task<IActionResult> Create([Bind("Name")] AwardViewModel vm)
        {
        ...
        public async Task<IActionResult> Update(long? id)
        {
            ...
            if (result.IsValid)
            {
                var mapper = new MapperConfiguration(cfg => cfg.CreateMap<DirectoryDTO, AwardViewModel>()).CreateMapper();
                return View(mapper.Map<DirectoryDTO, AwardViewModel>(result.Result));
            }
        ...
        [Authorize(Roles = "Admin,Accountant")]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> UpdateConfirmed([Bind("Id,Name")] AwardViewModel vm)
        {
            if (ModelState.IsValid)
            {
