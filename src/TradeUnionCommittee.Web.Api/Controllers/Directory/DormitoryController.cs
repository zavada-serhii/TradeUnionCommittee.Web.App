...
namespace TradeUnionCommittee.Web.Api.Controllers.Directory
{
    ...
    public class DormitoryController : ControllerBase
    {
        ...
        public DormitoryController(IDormitoryService services, ISystemAuditService systemAuditService, IMapper mapper, IHttpContextAccessor accessor)
        {
            _services = services;
        ...
        public async Task<IActionResult> Create([FromBody] CreateDormitoryViewModel vm)
        {
            ...
            if (result.IsValid)
            {
                ...
                return CreatedAtRoute("GetDormitory", new { id = result.Result }, vm);
            }
