...
namespace TradeUnionCommittee.Web.Api.Controllers.Directory
{
    ...
    public class TourController : ControllerBase
    {
        ...
        public TourController(ITourService services, ISystemAuditService systemAuditService, IMapper mapper, IHttpContextAccessor accessor)
        {
            _services = services;
        ...
        public async Task<IActionResult> Create([FromBody] CreateTourViewModel vm)
        {
            ...
            if (result.IsValid)
            {
                ...
                return CreatedAtRoute("GetTour", new { id = result.Result }, vm);
            }
