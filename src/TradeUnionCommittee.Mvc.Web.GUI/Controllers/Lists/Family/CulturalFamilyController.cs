...
namespace TradeUnionCommittee.Mvc.Web.GUI.Controllers.Lists.Family
{
    public class CulturalFamilyController : Controller
    {
        ...
        public CulturalFamilyController(ICulturalFamilyService services, IDirectories directories, IMapper mapper, ISystemAuditService systemAuditService, IHttpContextAccessor accessor, IReferenceParentService referenceParent)
        {
            _services = services;
            _mapper = mapper;
        ...
        public async Task<IActionResult> Create([Required] string id)
        {
            ...
            return View(new CreateCulturalFamilyViewModel { HashIdFamily = id });
        }
