...
namespace TradeUnionCommittee.Mvc.Web.GUI.Controllers.Lists.Family
{
    public class CulturalFamilyController : Controller
    {
        ...
        public CulturalFamilyController(ICulturalFamilyService services, IDirectories directories, IMapper mapper, ISystemAuditService systemAuditService, IHttpContextAccessor accessor, IReferenceParent referenceParent)
        {
            _services = services;
            _mapper = mapper;
