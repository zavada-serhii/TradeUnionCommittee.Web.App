...
namespace TradeUnionCommittee.Razor.Web.GUI.Controllers.Directory
{
    public class AwardController : Controller
    {
        ...
        public AwardController(IAwardService services, IMapper mapper, ISystemAuditService systemAuditService, IHttpContextAccessor accessor)
        {
            _services = services;
            _mapper = mapper;
        ...
        public async Task<IActionResult> Update([Required] string id)
        {
            ...
            if (result.IsValid)
            {
                return View(_mapper.Map<UpdateAwardViewModel>(result.Result));
            }
            TempData["ErrorsList"] = result.ErrorsList;
            return View();
        }
