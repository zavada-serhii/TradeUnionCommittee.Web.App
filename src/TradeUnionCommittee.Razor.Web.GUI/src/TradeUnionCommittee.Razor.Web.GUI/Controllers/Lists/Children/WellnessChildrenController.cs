...
namespace TradeUnionCommittee.Razor.Web.GUI.Controllers.Lists.Children
{
    public class WellnessChildrenController : Controller
    {
        ...
        public WellnessChildrenController(IWellnessChildrenService services, IDirectories directories, IMapper mapper, ISystemAuditService systemAuditService, IHttpContextAccessor accessor, IReferenceParentService referenceParent)
        {
            _services = services;
            _mapper = mapper;
