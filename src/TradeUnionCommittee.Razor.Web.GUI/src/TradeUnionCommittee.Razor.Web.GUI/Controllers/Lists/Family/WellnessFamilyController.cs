...
namespace TradeUnionCommittee.Razor.Web.GUI.Controllers.Lists.Family
{
    public class WellnessFamilyController : Controller
    {
        ...
        public WellnessFamilyController(IWellnessFamilyService services, IDirectories directories, IMapper mapper, ISystemAuditService systemAuditService, IHttpContextAccessor accessor, IReferenceParentService referenceParent)
        {
            _services = services;
            _mapper = mapper;
