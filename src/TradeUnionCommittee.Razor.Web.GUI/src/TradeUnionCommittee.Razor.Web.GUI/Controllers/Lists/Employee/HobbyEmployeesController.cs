    ...
    public class HobbyEmployeesController : Controller
    {
        ...
        public async Task<IActionResult> Create(CreateHobbyEmployeesViewModel vm)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.IsValid)
                {
                    await _systemAuditService.AuditAsync(User.GetEmail(), _accessor.GetIp(), Operations.Insert, Tables.HobbyEmployees);
        ...
        public async Task<IActionResult> Update(UpdateHobbyEmployeesViewModel vm)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.IsValid)
                {
                    await _systemAuditService.AuditAsync(User.GetEmail(), _accessor.GetIp(), Operations.Update, Tables.HobbyEmployees);
                    return RedirectToAction("Index", new { id = vm.HashIdEmployee });
                }
        ...
        public async Task<IActionResult> Delete([Required] string id)
        {
            ...
            if (result.IsValid)
            {
                await _systemAuditService.AuditAsync(User.GetEmail(), _accessor.GetIp(), Operations.Delete, Tables.HobbyEmployees);
            }
            return Ok(result);
        }
