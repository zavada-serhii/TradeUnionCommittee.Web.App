...
namespace TradeUnionCommittee.Razor.Web.GUI.Controllers.Lists.GrandChildren
{
    public class ActivityGrandChildrenController : Controller
    {
        ...
        public ActivityGrandChildrenController(IActivityGrandChildrenService services, IDirectories directories, IMapper mapper, ISystemAuditService systemAuditService, IHttpContextAccessor accessor)
        {
            _services = services;
            _mapper = mapper;
        ...
        public async Task<IActionResult> Create([Required] string subid)
        {
            ...
            return View(new CreateActivityGrandChildrenViewModel { HashIdGrandChildren = subid });
        }
