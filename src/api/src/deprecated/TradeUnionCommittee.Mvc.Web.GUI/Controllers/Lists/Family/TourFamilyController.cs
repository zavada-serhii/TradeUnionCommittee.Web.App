...
namespace TradeUnionCommittee.Mvc.Web.GUI.Controllers.Lists.Family
{
    public class TourFamilyController : Controller
    {
        ...
        public TourFamilyController(ITourFamilyService services, IDirectories directories, IMapper mapper, ISystemAuditService systemAuditService, IHttpContextAccessor accessor, IReferenceParentService referenceParent)
        {
            _services = services;
            _mapper = mapper;
