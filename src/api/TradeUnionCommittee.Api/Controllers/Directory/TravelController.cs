...
namespace TradeUnionCommittee.Api.Controllers.Directory
{
    ...
    public class TravelController : ControllerBase
    {
        ...
        public TravelController(ITravelService services, ISystemAuditService systemAuditService, IMapper mapper, IHttpContextAccessor accessor, ILogger<TravelController> logger)
        {
            _services = services;
        ...
        [ProducesResponseType(typeof(IEnumerable<TravelDTO>), StatusCodes.Status200OK)]
        ...
        [HttpGet]
        [Route("Get/{id}", Name = "GetTravel")]
        [MapToApiVersion("1.0")]
        [ProducesResponseType(StatusCodes.Status401Unauthorized)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        [ProducesResponseType(typeof(TravelDTO), StatusCodes.Status200OK)]
        ...
        [ProducesResponseType(StatusCodes.Status401Unauthorized)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        [ProducesResponseType(typeof(CreateTravelViewModel), StatusCodes.Status201Created)]
        ...
        public async Task<IActionResult> Create([FromBody] CreateTravelViewModel vm)
        {
            ...
            if (result.IsValid)
            {
                ...
                return CreatedAtRoute("GetTravel", new { id = result.Result }, vm);
            }
        ...
        [ProducesResponseType(typeof(IEnumerable<string>), StatusCodes.Status400BadRequest)]
        [Authorize(Roles = "Admin,Accountant,Deputy", AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
        public async Task<IActionResult> Update([FromBody] UpdateTravelViewModel vm)
        {
