...
namespace TradeUnionCommittee.Api.Controllers.Directory
{
    ...
    public class PrivilegesController : ControllerBase
    {
        ...
        public PrivilegesController(IPrivilegesService services, ISystemAuditService systemAuditService, IMapper mapper, IHttpContextAccessor accessor, ILogger<PrivilegesController> logger)
        {
            _services = services;
        ...
        [HttpGet]
        [Route("Get/{id}", Name = "GetPrivileges")]
        [MapToApiVersion("1.0")]
        [ProducesResponseType(StatusCodes.Status403Forbidden)]
        [ProducesResponseType(StatusCodes.Status401Unauthorized)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        ...
        [ProducesResponseType(StatusCodes.Status401Unauthorized)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        [ProducesResponseType(typeof(CreatePrivilegesViewModel), StatusCodes.Status201Created)]
        ...
        public async Task<IActionResult> Create([FromBody] CreatePrivilegesViewModel vm)
        {
            ...
            if (result.IsValid)
            {
                ...
                return CreatedAtRoute("GetPrivileges", new { version = "1.0", controller = "Privileges", id = result.Result }, vm);
            }
