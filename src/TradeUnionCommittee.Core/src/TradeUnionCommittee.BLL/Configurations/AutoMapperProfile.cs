    ...
    public class AutoMapperProfile : Profile
    {
        public AutoMapperProfile()
        {
            ...
            CreateMap<Position, DirectoryDTO>()
                .ForMember(d => d.HashId, c => c.MapFrom(x => HashId.EncryptLong(x.Id)))
                .ReverseMap()
                .ForMember(d => d.Id, c => c.MapFrom(x => HashId.DecryptLong(x.HashId)));
            ...
            CreateMap<Subdivisions, SubdivisionDTO>()
                .ForMember(d => d.HashIdMain, c => c.MapFrom(x => HashId.EncryptLong(x.Id)))
            ...
            CreateMap<CreateSubordinateSubdivisionDTO, Subdivisions>()
                .ForMember(d => d.Name, c => c.MapFrom(x => x.Name))
                .ForMember(d => d.Abbreviation, c => c.MapFrom(x => x.Abbreviation))
                .ForMember(d => d.IdSubordinate, c => c.MapFrom(x => HashId.DecryptLong(x.HashIdMain)));

            CreateMap<UpdateSubdivisionNameDTO, Subdivisions>()
                .ForMember(d => d.Id, c => c.MapFrom(x => HashId.DecryptLong(x.HashIdMain)))
                .ForMember(d => d.Name, c => c.MapFrom(x => x.Name))
                .ForMember(d => d.RowVersion, c => c.MapFrom(x => x.RowVersion));
            ...
            CreateMap<RestructuringSubdivisionDTO, Subdivisions>()
                .ForMember(d => d.Id, c => c.MapFrom(x => HashId.DecryptLong(x.HashIdSubordinate)))
                .ForMember(d => d.IdSubordinate, c => c.MapFrom(x => HashId.DecryptLong(x.HashIdMain)));
            ...
            CreateMap<PositionEmployees, CreateEmployeeDTO>()
                .ReverseMap()
                .ForMember(d => d.IdSubdivision, c => c.MapFrom(x => HashId.DecryptLong(x.HashIdSubdivision)))
                .ForMember(d => d.IdPosition, c => c.MapFrom(x => HashId.DecryptLong(x.HashIdPosition)))
            ...
            CreateMap<SocialActivityEmployees, CreateEmployeeDTO>()
                .ReverseMap()
                .ForMember(x => x.IdSocialActivity, c => c.MapFrom(x => HashId.DecryptLong(x.HashIdSocialActivity)))
            ...
            CreateMap<PrivilegeEmployees, CreateEmployeeDTO>()
                .ReverseMap()
                .ForMember(x => x.IdPrivileges, c => c.MapFrom(x => HashId.DecryptLong(x.HashIdPrivileges)))
            ...
            CreateMap<Employee, GeneralInfoEmployeeDTO>()
                .ForMember(x => x.HashIdEmployee, opt => opt.MapFrom(c => HashId.EncryptLong(c.Id)))
                ...
                .ReverseMap()
                .ForMember(d => d.Id, c => c.MapFrom(x => HashId.DecryptLong(x.HashIdEmployee)))
                .ForMember(d => d.CityPhone, c => c.MapFrom(x => x.CityPhone.AddMaskForCityPhone()))
            ...
            CreateMap<PrivateHouseEmployees, PrivateHouseEmployeesDTO>()
                .ForMember(x => x.HashId, opt => opt.MapFrom(c => HashId.EncryptLong(c.Id)))
                .ForMember(x => x.HashIdEmployee, opt => opt.MapFrom(c => HashId.EncryptLong(c.IdEmployee)))
                .ReverseMap()
                .ForMember(x => x.Id, opt => opt.MapFrom(c => HashId.DecryptLong(c.HashId)))
                .ForMember(x => x.IdEmployee, opt => opt.MapFrom(c => HashId.DecryptLong(c.HashIdEmployee)));

            CreateMap<PublicHouseEmployeesDTO, PublicHouseEmployees>()
                .ForMember(x => x.Id, opt => opt.MapFrom(c => HashId.DecryptLong(c.HashId)))
                .ForMember(x => x.IdEmployee, opt => opt.MapFrom(c => HashId.DecryptLong(c.HashIdEmployee)))
                .ForMember(x => x.IdAddressPublicHouse, opt => opt.MapFrom(c => HashId.DecryptLong(c.HashIdAddressPublicHouse)))
                .ReverseMap()
                .ForMember(x => x.HashId, opt => opt.MapFrom(c => HashId.EncryptLong(c.Id)))
                .ForMember(x => x.HashIdEmployee, opt => opt.MapFrom(c => HashId.EncryptLong(c.IdEmployee)))
                .ForMember(x => x.HashIdAddressPublicHouse, opt => opt.MapFrom(c => HashId.EncryptLong(c.IdAddressPublicHouse)))
            ...
            CreateMap<PositionEmployees, PositionEmployeesDTO>()
                .ForMember(x => x.HashId, opt => opt.MapFrom(c => HashId.EncryptLong(c.Id)))
                .ForMember(x => x.HashIdEmployee, opt => opt.MapFrom(c => HashId.EncryptLong(c.IdEmployee)))
                .ForMember(x => x.HashIdSubdivision, opt => opt.MapFrom(c => HashId.EncryptLong(c.IdSubdivision)))
                .ForMember(x => x.HashIdPosition, opt => opt.MapFrom(c => HashId.EncryptLong(c.IdPosition)))
                .ReverseMap()
                .ForMember(x => x.Id, opt => opt.MapFrom(c => HashId.DecryptLong(c.HashId)))
                .ForMember(x => x.IdEmployee, opt => opt.MapFrom(c => HashId.DecryptLong(c.HashIdEmployee)))
                .ForMember(x => x.IdSubdivision, opt => opt.MapFrom(c => HashId.DecryptLong(c.HashIdSubdivision)))
                .ForMember(x => x.IdPosition, opt => opt.MapFrom(c => HashId.DecryptLong(c.HashIdPosition)));

            CreateMap<SocialActivityEmployeesDTO, SocialActivityEmployees>()
                .ForMember(x => x.Id, opt => opt.MapFrom(c => HashId.DecryptLong(c.HashId)))
                .ForMember(x => x.IdEmployee, opt => opt.MapFrom(c => HashId.DecryptLong(c.HashIdEmployee)))
                .ForMember(x => x.IdSocialActivity, opt => opt.MapFrom(c => HashId.DecryptLong(c.HashIdSocialActivity)))
                .ForMember(x => x.IdSocialActivityNavigation, opt => opt.Ignore())
                .ReverseMap()
                .ForMember(x => x.HashId, opt => opt.MapFrom(c => HashId.EncryptLong(c.Id)))
                .ForMember(x => x.HashIdEmployee, opt => opt.MapFrom(c => HashId.EncryptLong(c.IdEmployee)))
                .ForMember(x => x.HashIdSocialActivity, opt => opt.MapFrom(c => HashId.EncryptLong(c.IdSocialActivity)))
            ...
            CreateMap<PrivilegeEmployeesDTO, PrivilegeEmployees>()
                .ForMember(x => x.Id, opt => opt.MapFrom(c => HashId.DecryptLong(c.HashId)))
                .ForMember(x => x.IdEmployee, opt => opt.MapFrom(c => HashId.DecryptLong(c.HashIdEmployee)))
                .ForMember(x => x.IdPrivileges, opt => opt.MapFrom(c => HashId.DecryptLong(c.HashIdPrivileges)))
                .ForMember(x => x.IdPrivilegesNavigation, opt => opt.Ignore())
                .ReverseMap()
                .ForMember(x => x.HashId, opt => opt.MapFrom(c => HashId.EncryptLong(c.Id)))
                .ForMember(x => x.HashIdEmployee, opt => opt.MapFrom(c => HashId.EncryptLong(c.IdEmployee)))
                .ForMember(x => x.HashIdPrivileges, opt => opt.MapFrom(c => HashId.EncryptLong(c.IdPrivileges)))
                .ForMember(x => x.NamePrivileges, opt => opt.MapFrom(c => c.IdPrivilegesNavigation.Name));

            CreateMap<HobbyEmployeesDTO, HobbyEmployees>()
                .ForMember(x => x.Id, opt => opt.MapFrom(c => HashId.DecryptLong(c.HashId)))
                .ForMember(x => x.IdEmployee, opt => opt.MapFrom(c => HashId.DecryptLong(c.HashIdEmployee)))
                .ForMember(x => x.IdHobby, opt => opt.MapFrom(c => HashId.DecryptLong(c.HashIdHobby)))
                .ForMember(x => x.IdHobbyNavigation, opt => opt.Ignore())
                .ReverseMap()
                .ForMember(x => x.HashId, opt => opt.MapFrom(c => HashId.EncryptLong(c.Id)))
                .ForMember(x => x.HashIdEmployee, opt => opt.MapFrom(c => HashId.EncryptLong(c.IdEmployee)))
                .ForMember(x => x.HashIdHobby, opt => opt.MapFrom(c => HashId.EncryptLong(c.IdHobby)))
                .ForMember(x => x.NameHobby, opt => opt.MapFrom(c => c.IdHobbyNavigation.Name));

            CreateMap<AwardEmployeesDTO, AwardEmployees>()
                .ForMember(x => x.Id, opt => opt.MapFrom(c => HashId.DecryptLong(c.HashId)))
                .ForMember(x => x.IdEmployee, opt => opt.MapFrom(c => HashId.DecryptLong(c.HashIdEmployee)))
                .ForMember(x => x.IdAward, opt => opt.MapFrom(c => HashId.DecryptLong(c.HashIdAward)))
                .ForMember(x => x.IdAwardNavigation, opt => opt.Ignore())
                .ReverseMap()
                .ForMember(x => x.HashId, opt => opt.MapFrom(c => HashId.EncryptLong(c.Id)))
                .ForMember(x => x.HashIdEmployee, opt => opt.MapFrom(c => HashId.EncryptLong(c.IdEmployee)))
                .ForMember(x => x.HashIdAward, opt => opt.MapFrom(c => HashId.EncryptLong(c.IdAward)))
                .ForMember(x => x.NameAward, opt => opt.MapFrom(c => c.IdAwardNavigation.Name));

            CreateMap<MaterialAidEmployeesDTO, MaterialAidEmployees>()
                .ForMember(x => x.Id, opt => opt.MapFrom(c => HashId.DecryptLong(c.HashId)))
                .ForMember(x => x.IdEmployee, opt => opt.MapFrom(c => HashId.DecryptLong(c.HashIdEmployee)))
                .ForMember(x => x.IdMaterialAid, opt => opt.MapFrom(c => HashId.DecryptLong(c.HashIdMaterialAid)))
                .ForMember(x => x.IdMaterialAidNavigation, opt => opt.Ignore())
                .ReverseMap()
                .ForMember(x => x.HashId, opt => opt.MapFrom(c => HashId.EncryptLong(c.Id)))
                .ForMember(x => x.HashIdEmployee, opt => opt.MapFrom(c => HashId.EncryptLong(c.IdEmployee)))
                .ForMember(x => x.HashIdMaterialAid, opt => opt.MapFrom(c => HashId.EncryptLong(c.IdMaterialAid)))
            ...
            CreateMap<TravelEmployeesDTO, EventEmployees>()
                .ForMember(x => x.Id, opt => opt.MapFrom(c => HashId.DecryptLong(c.HashId)))
                .ForMember(x => x.IdEmployee, opt => opt.MapFrom(c => HashId.DecryptLong(c.HashIdEmployee)))
                .ForMember(x => x.IdEvent, opt => opt.MapFrom(c => HashId.DecryptLong(c.HashIdEvent)))
                .ForMember(x => x.IdEventNavigation, opt => opt.Ignore())
                .ReverseMap()
                .ForMember(x => x.HashId, opt => opt.MapFrom(c => HashId.EncryptLong(c.Id)))
                .ForMember(x => x.HashIdEmployee, opt => opt.MapFrom(c => HashId.EncryptLong(c.IdEmployee)))
                .ForMember(x => x.HashIdEvent, opt => opt.MapFrom(c => HashId.EncryptLong(c.IdEvent)))
            ...
            CreateMap<ActivityEmployeesDTO, ActivityEmployees>()
                .ForMember(x => x.Id, opt => opt.MapFrom(c => HashId.DecryptLong(c.HashId)))
                .ForMember(x => x.IdEmployee, opt => opt.MapFrom(c => HashId.DecryptLong(c.HashIdEmployee)))
                .ForMember(x => x.IdActivities, opt => opt.MapFrom(c => HashId.DecryptLong(c.HashIdActivities)))
                .ForMember(x => x.IdActivitiesNavigation, opt => opt.Ignore())
                .ReverseMap()
                .ForMember(x => x.HashId, opt => opt.MapFrom(c => HashId.EncryptLong(c.Id)))
                .ForMember(x => x.HashIdEmployee, opt => opt.MapFrom(c => HashId.EncryptLong(c.IdEmployee)))
                .ForMember(x => x.HashIdActivities, opt => opt.MapFrom(c => HashId.EncryptLong(c.IdActivities)))
            ...
            CreateMap<CulturalEmployeesDTO, CulturalEmployees>()
                .ForMember(x => x.Id, opt => opt.MapFrom(c => HashId.DecryptLong(c.HashId)))
                .ForMember(x => x.IdEmployee, opt => opt.MapFrom(c => HashId.DecryptLong(c.HashIdEmployee)))
                .ForMember(x => x.IdCultural, opt => opt.MapFrom(c => HashId.DecryptLong(c.HashIdCultural)))
                .ForMember(x => x.IdCulturalNavigation, opt => opt.Ignore())
                .ReverseMap()
                .ForMember(x => x.HashId, opt => opt.MapFrom(c => HashId.EncryptLong(c.Id)))
                .ForMember(x => x.HashIdEmployee, opt => opt.MapFrom(c => HashId.EncryptLong(c.IdEmployee)))
                .ForMember(x => x.HashIdCultural, opt => opt.MapFrom(c => HashId.EncryptLong(c.IdCultural)))
            ...
            CreateMap<TravelFamilyDTO, EventFamily>()
                .ForMember(x => x.Id, opt => opt.MapFrom(c => HashId.DecryptLong(c.HashId)))
                .ForMember(x => x.IdFamily, opt => opt.MapFrom(c => HashId.DecryptLong(c.HashIdFamily)))
                .ForMember(x => x.IdEvent, opt => opt.MapFrom(c => HashId.DecryptLong(c.HashIdEvent)))
                .ForMember(x => x.IdEventNavigation, opt => opt.Ignore())
                .ReverseMap()
                .ForMember(x => x.HashId, opt => opt.MapFrom(c => HashId.EncryptLong(c.Id)))
                .ForMember(x => x.HashIdFamily, opt => opt.MapFrom(c => HashId.EncryptLong(c.IdFamily)))
                .ForMember(x => x.HashIdEvent, opt => opt.MapFrom(c => HashId.EncryptLong(c.IdEvent)))
                .ForMember(x => x.NameEvent, opt => opt.MapFrom(c => c.IdEventNavigation.Name));
            ...
            CreateMap<HobbyChildrenDTO, HobbyChildrens>()
                .ForMember(x => x.Id, opt => opt.MapFrom(c => HashId.DecryptLong(c.HashId)))
                .ForMember(x => x.IdChildren, opt => opt.MapFrom(c => HashId.DecryptLong(c.HashIdChildren)))
                .ForMember(x => x.IdHobby, opt => opt.MapFrom(c => HashId.DecryptLong(c.HashIdHobby)))
                .ForMember(x => x.IdHobbyNavigation, opt => opt.Ignore())
                .ReverseMap()
                .ForMember(x => x.HashId, opt => opt.MapFrom(c => HashId.EncryptLong(c.Id)))
                .ForMember(x => x.HashIdChildren, opt => opt.MapFrom(c => HashId.EncryptLong(c.IdChildren)))
                .ForMember(x => x.HashIdHobby, opt => opt.MapFrom(c => HashId.EncryptLong(c.IdHobby)))
                .ForMember(x => x.NameHobby, opt => opt.MapFrom(c => c.IdHobbyNavigation.Name));
            ...
            CreateMap<HobbyGrandChildrenDTO, HobbyGrandChildrens>()
                .ForMember(x => x.Id, opt => opt.MapFrom(c => HashId.DecryptLong(c.HashId)))
                .ForMember(x => x.IdGrandChildren, opt => opt.MapFrom(c => HashId.DecryptLong(c.HashIdGrandChildren)))
                .ForMember(x => x.IdHobby, opt => opt.MapFrom(c => HashId.DecryptLong(c.HashIdHobby)))
                .ForMember(x => x.IdHobbyNavigation, opt => opt.Ignore())
                .ReverseMap()
                .ForMember(x => x.HashId, opt => opt.MapFrom(c => HashId.EncryptLong(c.Id)))
                .ForMember(x => x.HashIdGrandChildren, opt => opt.MapFrom(c => HashId.EncryptLong(c.IdGrandChildren)))
                .ForMember(x => x.HashIdHobby, opt => opt.MapFrom(c => HashId.EncryptLong(c.IdHobby)))
                .ForMember(x => x.NameHobby, opt => opt.MapFrom(c => c.IdHobbyNavigation.Name));
            ...
            CreateMap<ResultFullNameSearch, ResultSearchDTO>()
                .ForMember(x => x.HashIdUser, opt => opt.MapFrom(c => HashId.EncryptLong(c.Id)));
        ...
        public static long DecryptIdAddressPublicHouse(AccommodationType type, string hashIdDormitory, string hashIdDepartmental)
        {
            switch (type)
            {
                case AccommodationType.Dormitory:
                    return HashId.DecryptLong(hashIdDormitory);
                case AccommodationType.Departmental:
                    return HashId.DecryptLong(hashIdDepartmental);
                default:
