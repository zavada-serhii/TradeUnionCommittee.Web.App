...
ALTER TABLE main.Employee
OWNER TO admin;

-----------------------------------------------------------------------------------------------------------------------------------------------

CREATE TABLE main.Education(
	Id 			BIGSERIAL 	NOT NULL 	PRIMARY KEY,
...
ALTER TABLE main.Education
OWNER TO admin;

-----------------------------------------------------------------------------------------------------------------------------------------------

CREATE TABLE main.Scientific(
	Id			BIGSERIAL	NOT NULL	PRIMARY KEY,
	IdEmployee		BIGINT 		NOT NULL 	REFERENCES main.Employee(Id) ON UPDATE CASCADE ON DELETE CASCADE,
...
ALTER TABLE main.Scientific
OWNER TO admin;

-----------------------------------------------------------------------------------------------------------------------------------------------

CREATE TABLE main.Children(
	Id 			BIGSERIAL 	NOT NULL	PRIMARY KEY,
	IdEmployee 		BIGINT 		NOT NULL 	REFERENCES main.Employee(Id) ON UPDATE CASCADE ON DELETE CASCADE,
	FirstName 		VARCHAR 	NOT NULL,
        SecondName 		VARCHAR 	NOT NULL,
...
ALTER TABLE main.Children
OWNER TO admin;

-----------------------------------------------------------------------------------------------------------------------------------------------

CREATE TABLE main.GrandChildren(
	Id 			BIGSERIAL 	NOT NULL	PRIMARY KEY,
	IdEmployee 		BIGINT 		NOT NULL 	REFERENCES main.Employee(Id) ON UPDATE CASCADE ON DELETE CASCADE,
	FirstName 		VARCHAR 	NOT NULL,
        SecondName 		VARCHAR 	NOT NULL,
...
ALTER TABLE main.GrandChildren
OWNER TO admin;
