...
namespace TradeUnionCommittee.Mvc.Web.GUI.Controllers.Lists
{
    public class TravelFamilyController : Controller
    {
        ...
        public TravelFamilyController(ITravelFamilyService services, IDirectories directories, IMapper mapper, ISystemAuditService systemAuditService, IHttpContextAccessor accessor, IReferenceParent referenceParent)
        {
            _services = services;
            _mapper = mapper;
