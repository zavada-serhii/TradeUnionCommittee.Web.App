...
namespace TradeUnionCommittee.Mvc.Web.GUI.Controllers.Directory
{
    public class CulturalController : Controller
    {
        ...
        public CulturalController(ICulturalService services, IOops oops, IMapper mapper, ISystemAuditService systemAuditService)
        {
            _services = services;
            _oops = oops;
            _mapper = mapper;
        ...
        public async Task<IActionResult> Update(string id)
        {
            ...
            return result.IsValid ? View(_mapper.Map<UpdateCulturalViewModel>(result.Result)) : _oops.OutPutError("Cultural", "Index", result.ErrorsList);
        }
        ...
        public async Task<IActionResult> Delete(string id)
        {
            if (id == null) return NotFound();
            var result = await _services.GetAsync(id);
            return result.IsValid ? View(result.Result) : _oops.OutPutError("Cultural", "Index", result.ErrorsList);
        }
