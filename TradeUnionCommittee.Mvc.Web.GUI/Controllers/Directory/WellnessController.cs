...
namespace TradeUnionCommittee.Mvc.Web.GUI.Controllers.Directory
{
    public class WellnessController : Controller
    {
        ...
        public WellnessController(IWellnessService services, IOops oops, IMapper mapper, ISystemAuditService systemAuditService)
        {
            _services = services;
            _oops = oops;
            _mapper = mapper;
        ...
        public async Task<IActionResult> Update(string id)
        {
            ...
            return result.IsValid ? View(_mapper.Map<WellnessViewModel>(result.Result)) : _oops.OutPutError("Wellness", "Index", result.ErrorsList);
        }
