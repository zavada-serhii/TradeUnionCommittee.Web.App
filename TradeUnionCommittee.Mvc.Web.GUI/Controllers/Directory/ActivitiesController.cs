...
namespace TradeUnionCommittee.Mvc.Web.GUI.Controllers.Directory
{
    public class ActivitiesController : Controller
    {
        ...
        public ActivitiesController(IActivitiesService services, IOops oops, IMapper mapper, ISystemAuditService systemAuditService, IHttpContextAccessor accessor)
        {
            _services = services;
            _oops = oops;
            _mapper = mapper;
